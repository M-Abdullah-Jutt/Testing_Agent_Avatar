...
def create_workflow():
    ...
    pdf_path = os.getenv("COMPANY_PDF_PATH")
    ...
    def call_llm(state: InterviewState) -> InterviewState:
        ...
        system_prompt = (
            ...
            "- When the candidate asks questions about the company (mission, culture, vision, etc.), use the company_info_tool to find relevant information\n"
